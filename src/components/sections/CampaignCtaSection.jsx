...
export function CampaignCtaSection({ variant }) {
  ...
  return (
    <section id="cta" className="relative overflow-hidden px-6 pb-20 pt-12">
      ...
      <div className="relative z-10 mx-auto max-w-5xl text-center">
        <p className="mb-6 text-xs font-bold tracking-[0.28em] text-white/75 uppercase">{finalCta.eyebrow}</p>
        ...
        <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-white/78">{finalCta.description}</p>
